...
class LevelMissionCondition extends MissionCondition implements Observer {
    targetLevel: number;
    fatherFunc: Function;
...
class KillMonsterMissionCondition extends MissionCondition implements Observer {
